...
const adaptEventoCourses = [
	...
	adaptLP({original: {lp: "an", subj: "BG"}, classIncludes: "20a", newLp: "lo"}),
	adaptLP({original: {lp: "sb", subj: "P"}, classIncludes: "21c", newLp: "sa"}),
	adaptLP({original: {lp: "js", subj: "KS"}, classIncludes: "21f", newLp: "we"}),
